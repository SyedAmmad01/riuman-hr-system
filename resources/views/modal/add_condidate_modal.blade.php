                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="time_from_last_job"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control " id="time_to_last_job"
                                    placeholder="Time To Last Job" name="time_to_last_job">
                                {{-- <span class="text-danger">{{ $errors->first('time_to_last_job') }}</span> --}}
                            </div>
                            <div class="mb-3">
