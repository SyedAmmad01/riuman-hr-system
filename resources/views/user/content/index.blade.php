                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" value="{{ $contents->name }}"
                                                        readonly>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $contents->cnic_number }}" readonly>
                                                </div>

                                                <div class="mb-3">
                                                    <label for="validationDOB">Condidate Date Of Birth</label>
                                                    <input type="text" class="form-control" value="{{ $contents->dob }}"
                                                        readonly>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $contents->number }}" readonly>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        @else
                                                                            <tr>
                                                                                ...
                                                                                <input type="hidden" name="attendence"
                                                                                    value=''>
                                                                            </tr>
                                                                        @endif
                                                                    </tbody>
